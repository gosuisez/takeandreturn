            ...
            <Content contentContainerStyle={theme.container} style={theme.content}>
                <ScrollView>
                    <View style={theme.descriptionSection}>
                        <Text style={theme.descriptionText}>Началната страница съдържа нашето авторско информативно видео, кратко описание и бутон за нашата информативна страница.</Text>
                    </View>
                    <View style={theme.imageSection}>
                        <Image style={theme.imageFrame} source={require('@app/assets/images/Home/1.png')}/>
                    </View>
                </ScrollView>
            </Content>
        );
