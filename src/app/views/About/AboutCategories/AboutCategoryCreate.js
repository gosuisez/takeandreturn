            ...
            <Content contentContainerStyle={theme.container} style={theme.content}>
                <ScrollView>
                    <View style={theme.descriptionSection}>
                        <Text style={theme.descriptionText}>Страницата за създаване на категория представлява форма, в която вие трябва да въведете име на категорията, която искате да добавите.</Text>
                    </View>
