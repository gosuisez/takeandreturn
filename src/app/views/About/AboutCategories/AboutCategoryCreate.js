...
class AboutCategoryCreate extends Component {
            ...
            <Content contentContainerStyle={custom.container} style={custom.content}>
                <ScrollView>
                    <View style={custom.descriptionSection}>
                        <Text style={responsive.descriptionText}>Страницата за създаване на категория представлява форма, в която вие трябва да въведете име на категорията, която искате да добавите.</Text>
                    </View>
                    <View style={custom.imageSection}>
                        <Image style={responsive.imageFrame} source={require('@app/assets/images/Categories/7.png')}/>
                    </View>
                </ScrollView>
            </Content>
        );
...
/* Exports */
export default withTheme(AboutCategoryCreate);
/* /Exports/ */
