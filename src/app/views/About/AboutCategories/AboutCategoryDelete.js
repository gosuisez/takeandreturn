            ...
            <Content contentContainerStyle={theme.container} style={theme.content}>
                <ScrollView>
                    <View style={theme.descriptionSection}>
                        <Text style={theme.descriptionText}>Страницата за премахване на категория представлява форма, в която вие можете да премахнете създадената от вас категория.</Text>
                    </View>
