...
class AboutAppUs extends Component {
            ...
            <Content contentContainerStyle={custom.container} style={custom.content}>
                <ScrollView>
                    <View style={custom.descriptionSection}>
                        <Text style={responsive.descriptionText}>За нас е страница с кратка информация относно нас.</Text>
                    </View>
                    <View style={custom.imageSection}>
                        <Image style={responsive.imageFrame} source={require('@app/assets/images/Settings/16.png')}/>
                    </View>
                </ScrollView>
            </Content>
        );
...
/* Exports */
export default withTheme(AboutAppUs);
/* /Exports/ */
