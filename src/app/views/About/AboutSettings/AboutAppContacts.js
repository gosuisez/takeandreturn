            ...
            <Content contentContainerStyle={theme.container} style={theme.content}>
                <ScrollView>
                    <View style={theme.descriptionSection}>
                        <Text style={theme.descriptionText}>Контакти е бутон с препратка към вашата поща, където можете да се свържете с нас.</Text>
                    </View>
                    <View style={theme.imageSection}>
                        <Image style={theme.imageFrame} source={require('@app/assets/images/Settings/11.png')}/>
                    </View>
                </ScrollView>
            </Content>
        );
