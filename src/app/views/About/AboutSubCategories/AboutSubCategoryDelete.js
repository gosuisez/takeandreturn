...
class AboutSubCategoryDelete extends Component {
            ...
            <Content contentContainerStyle={custom.container} style={custom.content}>
                <ScrollView>
                    <View style={custom.descriptionSection}>
                        <Text style={responsive.descriptionText}>Страницата за премахване на подкатегория представлява форма, в която вие можете да премахнете създадената от вас подкатегория.</Text>
                    </View>
                    <View style={custom.imageSection}>
                        <Image style={responsive.imageFrame} source={require('@app/assets/images/SubCategories/9.png')}/>
                    </View>
                </ScrollView>
            </Content>
        );
...
/* Exports */
export default withTheme(AboutSubCategoryDelete);
/* /Exports/ */
