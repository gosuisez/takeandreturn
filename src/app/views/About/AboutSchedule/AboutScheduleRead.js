            ...
            <Content contentContainerStyle={theme.container} style={theme.content}>
                <ScrollView>
                    <View style={theme.descriptionSection}>
                        <Text style={theme.descriptionText}>Страницата за преглеждане на график на работник представлява детайли за работника, като име, презиме, фамилия, дата на започване, час на започване, дата на приключване и час на приключване.</Text>
                    </View>
                    <View style={theme.imageSection}>
                        <Image style={theme.imageFrame} source={require('@app/assets/images/Schedules/4.png')}/>
                    </View>
                </ScrollView>
            </Content>
        );
