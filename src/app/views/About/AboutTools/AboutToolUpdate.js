            ...
            <Content contentContainerStyle={custom.container} style={custom.content}>
                <ScrollView>
                    <View style={custom.descriptionSection}>
                        <Text style={responsive.descriptionText}>Страницата за редактиране на инструмент представлява форма, в която вие можете да промените името, описанието, бройката и наличността на създадения от вас инструмент.</Text>
                    </View>
                    <View style={custom.imageSection}>
                        <Image style={responsive.imageFrame} source={require('@app/assets/images/Tools/6.png')}/>
                    </View>
                </ScrollView>
            </Content>
        );
