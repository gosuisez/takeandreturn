...
class AboutToolDelete extends Component {
            ...
            <Content contentContainerStyle={theme.container} style={theme.content}>
                <ScrollView>
                    <View style={theme.descriptionSection}>
                        <Text style={theme.descriptionText}>Страницата за премахване на инструмент представлява форма, в която вие можете да премахнете създаденият от вас инструмент.</Text>
                    </View>
                    <View style={theme.imageSection}>
                        <Image style={theme.imageFrame} source={require('@app/assets/images/Tools/6.png')}/>
                    </View>
                </ScrollView>
            </Content>
        );
...
export default withTheme(AboutToolDelete);
