            ...
            <Content contentContainerStyle={theme.container} style={theme.content}>
                <ScrollView>
                    <View style={theme.descriptionSection}>
                        <Text style={theme.descriptionText}>Страницата за преглеждане на инструмент представлява детайли за инструмента, като идентификационен номер, име, описание, брой и наличност.</Text>
                    </View>
                    <View style={theme.imageSection}>
                        <Image style={theme.imageFrame} source={require('@app/assets/images/Tools/4.png')}/>
                    </View>
                </ScrollView>
            </Content>
        );
