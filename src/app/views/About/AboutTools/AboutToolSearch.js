            ...
            <Content contentContainerStyle={theme.container} style={theme.content}>
                <ScrollView>
                    <View style={theme.descriptionSection}>
                        <Text style={theme.descriptionText}>Страницата за търсене на инструмент представлява търсачка, в която вие трябва да въведете име на инструмент, който искате да потърсите в списъка.</Text>
                    </View>
                    <View style={theme.imageSection}>
                        <Image style={theme.imageFrame} source={require('@app/assets/images/Tools/2.png')}/>
                    </View>
                </ScrollView>
            </Content>
        );
