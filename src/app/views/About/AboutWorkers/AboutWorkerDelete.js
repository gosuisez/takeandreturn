            ...
            <Content contentContainerStyle={theme.container} style={theme.content}>
                <ScrollView>
                    <View style={theme.descriptionSection}>
                        <Text style={theme.descriptionText}>Страницата за премахване на работник представлява форма, в която вие можете да премахнете създаденият от вас работник.</Text>
                    </View>
                    <View style={theme.imageSection}>
                        <Image style={theme.imageFrame} source={require('@app/assets/images/Workers/8.png')}/>
                    </View>
                </ScrollView>
            </Content>
        );
