...
class AboutWorkerDelete extends Component {
            ...
            <Content contentContainerStyle={custom.container} style={custom.content}>
                <ScrollView>
                    <View style={custom.descriptionSection}>
                        <Text style={responsive.descriptionText}>Страницата за премахване на работник представлява форма, в която вие можете да премахнете създаденият от вас работник.</Text>
                    </View>
                    <View style={custom.imageSection}>
                        <Image style={responsive.imageFrame} source={require('@app/assets/images/Workers/15.png')}/>
                    </View>
                </ScrollView>
            </Content>
        );
...
/* Exports */
export default withTheme(AboutWorkerDelete);
/* /Exports/ */
