...
class AboutAbsenceRead extends Component {
            ...
            <Content contentContainerStyle={custom.container} style={custom.content}>
                <ScrollView>
                    <View style={custom.descriptionSection}>
                        <Text style={responsive.descriptionText}>Страницата за преглеждане на отсъствие представлява детайли за работника, като име, презиме, фамилия, причина за отсъствие и дата на отсъствие.</Text>
                    </View>
                    <View style={custom.imageSection}>
                        <Image style={responsive.imageFrame} source={require('@app/assets/images/Absences/4.png')}/>
                    </View>
                </ScrollView>
            </Content>
        );
...
/* Exports */
export default withTheme(AboutAbsenceRead);
/* /Exports/ */
