            ...
            <Content contentContainerStyle={theme.container} style={theme.content}>
                <ScrollView>
                    <View style={theme.descriptionSection}>
                        <Text style={theme.descriptionText}>Страницата за редактиране на отсъствие представлява форма, в която вие можете да промените причината на отсъствие и датата на отсъствие на създаденото от вас отсъствие.</Text>
                    </View>
